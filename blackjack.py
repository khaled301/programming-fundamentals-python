...
class Hand:
  ...
  def display(self, show_all_dealer_cards = False):
    # triple quotes used here to use single and double quotes together
    print(f'''{"Dealer's" if self.dealer else "Your"} hand:''')

    # back slash indicates here is that the logic will continue in the next line
...
class Game():
  def play(self):
    ...
    while game_number < games_to_play:
      ...
      print()
      # print astrick 30 times as separator
      print("*" * 30)
